...
- **Branch model:** feature/fix/docs/design branches → `develop` → `main`. Don't push directly to `main`. The `develop` branch was recently resynced to `main` (2026-04-18) — all new work branches off `develop`.
